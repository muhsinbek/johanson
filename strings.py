...
source = {
    "keys": ["olma", "yo'lbars", "ruchka", "wifi", "kitob", "toshbaqa", "kaktus", "hamkorlik", "hayot", "kema",
             ...
             "kiuf", "monitor", "grafika", "choynak", "apelsin", "diplomat", "kelajak", "daraxt", "bolta", "tuxum",
             "xazina", "onajonim", "xalq", "bolalik", "jannat", "farishta", "tabassum"],
    "warn": "⚠️<b> Guruhda behayo so'zlarni gapirish taqiqlanadi!</b>\n\n 🍀 Iltimos bu mavzuga boshqa qaytmang ",
    "new_member": "Salom {name}! KIUF #offtop guruhiga xush kelibsiz!\n\nSiz hozir guruhda faqat o'qiy olasiz. Yozish "
                  ...
                  + botlink + " qoidalari←</a>",
    "new_member_rules": "KIUF #offtop guruhida ushbu qoidalarga qat'iy amal qiling:\n\n - behayo gaplarni gapirish;\n - "
...
U medaldan ko'ra ko'proq narsa beradi sizga.
Guruhda hurmatni saqlang, adminlarimiz ozroq ishkalchiroq, guruhni
chiqish eshigini ko'rsatvorishlari mumkin).

Manabu hunarim esa faqat IT dagi dasturchi yigitlarga kerak bo'ladi
...
(Mani guruhda Johanson deb chaqiring, bot demang, hazillashmadim shu joyida!)
""",
    "congrats": "Juda yaxshi!\nKIUF davrasiga xush kelibsiz :)\n\nYana bir bor eslatib o'tamiz: O'zingizni"
                " hurmat qiling!",
    ...
    "zen": """The KIUF #offtop Chat
(Inspired by "Black Web Team by KIUF")
...
- Git repos are one honking great idea — let's do more of those!""",
    "zen_uz": """KIUF #offtop guruhining 'The Zen' maslahatlar to'plami
(Tim Peters'ning qoidalar to'plamidan ilhomlanib yozilgan)
...
- Yaxshi gaplardan gaplashish behayo gaplarni gapirishdan yaxshi.
- Lekin yaxshi mavzuda gaplashish bu vaqt ajratishga arziydigan hol.
- Faqat u habar ga link berish bilan boshlanmagan bo'lsa.
...
- Qoidalarga amal qilish adminlarning (ayniqsa Johanson) nazariga tushishdan yaxshiroq.
- Uxlashdan oldin tishni yuvib yotish sog'liqqa foydali.""",
    ...
    "fatal_error": "Kutilmagan xatolik yuz berdi, iltimos, ushbu xabarni @muhsinbekoff'ga jo'nating",
...
<b>Sertifikat:</b>
    ...
    "user": "Foydalanuvchi",
    "user_info_not_a_member": "Ayni paytda KIUF #offtop guruhi a\'zosi emas",
